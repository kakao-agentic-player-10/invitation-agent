...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "(geocode_address for coordinates if available) → check_calendar_conflict → create_calendar_event. "
        "If geocode_address fails, continue with check_calendar_conflict and create_calendar_event "
        "using place_name/address without lat/lng. "
